...
export default function WelpenyPrivacyPolicyPage() {
  return (
    <div>
      <div className={title({ size: "sm" })}>Welpeny: Политика конфиденциальности</div>
      <br />
      <br />
      <br />
      ...
      <p>
        ...
        to as "Application") for mobile devices, which was developed by
        Kanstantsin Markau &amp; Hanna Markava (hereinafter referred to as
