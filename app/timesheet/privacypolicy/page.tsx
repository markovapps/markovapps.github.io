    ...
    return (
        <section
            ...
            <div>
                ...
                <br/>
                <p>
                    This Privacy Policy applies to the current version of Timesheet and, where specifically stated,
                    to certain legacy versions that may still be installed on users&apos; devices.
                </p>
                <br/>

                <strong>1. Informational Purpose and Calculation Disclaimer</strong>
                <p>
                    Timesheet is a productivity and record-keeping tool intended to help users record working time,
                    plan work schedules, organize work-related information and estimate earnings or other amounts
                    based on information entered or configured by the user.
                </p>
                <br/>
                <p>
                ...
                <br/>
                <p>
                    To the extent permitted by applicable law, the Service Provider is not responsible for differences
                    between amounts calculated or displayed by Timesheet and amounts actually paid, withheld, deducted,
                ...
                <p>
                    Timesheet allows you to enter and generate information related to your work and working time.
                    This may include, for example:
                </p>
                <ul className="list-disc list-inside indent-2">
                    <li>work records, dates, working hours and schedules;</li>
                    <li>start and end times and breaks;</li>
                    <li>rates and compensation-related information;</li>
                    <li>bonuses, allowances, adjustments and deductions;</li>
                    <li>user-created templates;</li>
                    <li>other information created through Timesheet features.</li>
                </ul>
                <p>
                ...
                <br/>
                <p>
                    Depending on the features you use, some information may leave your device when:
                </p>
                <ul className="list-disc list-inside indent-2">
                    <li>you use optional cloud backup or synchronization;</li>
                    <li>you export and share a document;</li>
                    <li>the Application sends product analytics or performance information;</li>
                    <li>advertising services are used;</li>
                    <li>an iOS subscription is purchased or managed;</li>
                    <li>you contact us through the feedback form or email.</li>
                </ul>
                <p>
                ...
                <p>
                    Timesheet allows you to create reports and documents in formats such as PDF, XLSX and HTML.
                    These documents are generated locally on your device. Timesheet does not automatically upload
                    exported documents to our servers. An exported document leaves the Application only when you
                    choose to save or share it using your device&apos;s system sharing options.
                </p>
                <br/>
                <p>
